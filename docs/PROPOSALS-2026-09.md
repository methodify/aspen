...
MIGRATION.md), §6 as v0.12 and §7 as v0.13 (2026-09-07; BOARDS.md, PLUGINS.md).
§5 phases 3–4 and §8 are open (BACKLOG B-5b, B-8). Backlog ids in BACKLOG.md. Each section says what is asked, what exists today, the
